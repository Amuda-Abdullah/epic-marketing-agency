...
import { david, emily, mabel, marcus, sarah } from "../assets";
  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      description: "With 3+ years in digital marketing, Sarah develops strategies for all our packages ($500-$3,500) to maximize ROI for authors.",
    },
    {
      id: 2,
      name: "Marcus Walker",
    ...
    },
    {
      ...
      description: "David creates stunning visuals for our $5000+ packages, including book covers and promotional graphics.",
    },
    {
      id: 5,
      name: "Mabel Anna",
      image: mabel,
      role: "Content Writer & Amazon Reviews Specialist",
      description: "Mabel crafts compelling content and manages Amazon review campaigns for our $1,200+ packages, enhancing book visibility and credibility.",
    },
  ];
